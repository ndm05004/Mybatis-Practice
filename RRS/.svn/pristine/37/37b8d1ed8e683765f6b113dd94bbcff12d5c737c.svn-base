...
public class JoinRst extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String uploadPath = "D:\\A_TeachingMatrial\\3_highjava\\workspace\\RRS\\src\\main\\webapp\\images";																														// 설정이
																														// 될까?
		...
		response.sendRedirect(request.getContextPath()+"/restaurant/joinTest.jsp?res="+res);
	}
