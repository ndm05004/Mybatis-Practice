...
public class RestautantVO {
	...
	private double starcountavg; // 별점
	...
	private String accept; // 승인 완료 후 등록된 날짜
	private String ctg_id;
	private String rst_req; // 승인 요청한 날짜
	...
	public void setRst_req(String rst_req) {
		this.rst_req = rst_req;
	}
	...
	public double getStarcountavg() {
		return starcountavg;
	}

	public void setStarcountavg(double starcountavg) {
	...
	public String toString() {
		return "RestautantVO [rst_id=" + rst_id + ", rst_name=" + rst_name + ", rst_addr=" + rst_addr + ", rst_tel="
				...
				+ ", closetime=" + closetime + ", accept=" + accept + ", ctg_id=" + ctg_id + ", rst_req=" + rst_req
				+ "]";
	}
