...
<div class="container">
  ...
  <form action="" class="needs-validation" novalidate>
    ...
    <button type="submit" class="btn btn-primary" id="verifi">인증번호 받기</button><br><br>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <input type="text" class="form-control" name="subverifi"placeholder="인증번호 입력"><br>
