...
/**
 * Servlet implementation class CancelBookMark
 */
@WebServlet("/member/cancelBookMark.do")
public class CancelBookMark extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int res = service.cancelBookMark(vo);
