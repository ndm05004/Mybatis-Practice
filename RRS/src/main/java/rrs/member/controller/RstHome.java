...
/**
 * Servlet implementation class RstHome
 */
@WebServlet("/rstHome.do")
public class RstHome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("rstinfo", vo);

		request.getRequestDispatcher("/member/view/rstHome.jsp").forward(request, response);
