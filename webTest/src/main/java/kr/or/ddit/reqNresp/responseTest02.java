...
public class responseTest02 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 - redirect
		 	==> 다른 페이지로 넘어가도록 하는 기능을 말한다.
		 		...
		 		이동하는 방식을 말한다. (재 요청할 대는 GET방식으로의 요청이기 때문에 URL의 길이에 제한이 있다.)
		...
		*/
		//request.setAttribute("tel", "010-999-9999"); // redirect는 이런식으로 데이터를 보낼 수 없다.
		
		// 이 문서에서는 만들어진 데이터를 Redirect문서로 보내려면 
		String name = request.getParameter("username");
		String tel = "010-999-9999";
